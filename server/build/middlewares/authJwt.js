      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            token = req.headers.authorization.split(" ")[1]; // Token Sent Verification
          ...
          case 4:
            ...
            decoded = jwt.verify(token, SECRET); // Id user saved on Request Object

            req.userId = decoded.id; // User Data
